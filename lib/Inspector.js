            ...
            var toShadow = function(util, customEqualityTesters) {
                return {
                    compare: function(actual, expected) {
                        ...
                        var getOwnPropFromScopeChain = function(scope,prop) {
                            if(scope === null) {
                                return false;
                            }
                            if(scope.hasOwnProperty(prop)) {
                                ...
                                return getOwnPropFromScopeChain.apply(null,scope.$parent,prop);
                            }
                        };

                        var shadowed = [];
                        expected.forEach(function(member) {
                            if(actual.hasOwnProperty(member) && getOwnPropFromScopeChain(actual.$parent,member) === true) {
                        ...
                        return compareArraysAndTrace(actual.$id, Object.keys(shadowed), expected, msgPass, msgFail);
                    }
                };
            };
            return {
