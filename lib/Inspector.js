(function () {
    ...
    angular.module('scope-aware', [])
        .service('Inspector', ['$rootScope', function ($rootScope) {
            ...
            var hasPropInScopeChain = function(anyScope,prop) {
                if(anyScope === null) {
                    return false;
                }
                if(anyScope.hasOwnProperty(prop)) {
                    ...
                    return hasPropInScopeChain.call(null,anyScope.$parent,prop);
                }
            };
            ...
            return {
                ...
                hasPropInScopeChain: hasPropInScopeChain,
            ...
            var toShadow = function(util, customEqualityTesters) {
                return {
                    compare: function(actual, expected) {
                        ...
                        var shadowed = [];
                        expected.forEach(function(member) {
                            if(actual.hasOwnProperty(member) && Inspector.hasPropInScopeChain(actual.$parent,member) === true) {
